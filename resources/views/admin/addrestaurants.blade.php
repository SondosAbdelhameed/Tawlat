...
<div class="col-sm-4">
    <div class="form-group">
      ...
      <input type="number" step="0.0001" class="form-control" name="longitude" value="{{ old('longitude') }}" required>
  ...
  <div class="col-sm-4">
    <div class="form-group">
       ...
       <select class="form-control selectpicker"  data-live-search="true" value="{{ old('city_id') }}" name="city_id" id="main_category" onChange="main_category_val()">
 ...
 <div class="col-sm-4">
   ...
   <div class="col-sm-4">
    <div class="form-group">
      ...
      <input type="text" class="form-control"  name="table_count" value="{{ old('table_count') }}" required>
...
<div class="form-group">
  <label for="email">العدد المسموح</label>
      <input type="text" class="form-control" name="people_limit" value="{{ old('people_limit') }}">
    </div>
 </div>
</div>
</div>
...
<input type="checkbox"  name="category_id[]" value="{{$item->id}}"><br>
@endforeach
    </div>
 </div>
</div>
